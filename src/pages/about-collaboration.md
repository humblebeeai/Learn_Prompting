...
- **Localization & Maintenance**: Managed by [HumblebeeAI Academy](https://academy.humblebee.ai).
- **License**: This content is licensed under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/). You are free to share and adapt the material for non-commercial purposes, provided you give appropriate credit and distribute your contributions under the same license.

## Contact
For issues regarding the translation or platform, please contact HumblebeeAI or open an issue in our [GitHub repository](https://github.com/humblebeeai/Learn_Prompting).
