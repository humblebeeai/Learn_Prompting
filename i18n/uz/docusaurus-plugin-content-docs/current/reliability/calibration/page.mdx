...
Keling, tezkor misolni ko‘rib chiqamiz: Aytaylik, bizda ikki mumkin bo‘lgan yorliq, `Positive` va `Negative` bo‘lgan <Term term="sentiment analysis"> sentiment analysis </Term> vazifasi bor.
<Term term="LLM"> LLM </Term> ga `Input: nothing Sentiment: ` bilan prompt berilganda nima sodir bo‘lishini ko‘rib chiqing.
