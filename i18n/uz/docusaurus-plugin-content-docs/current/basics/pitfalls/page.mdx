...
*Matematik masalalarni qisman yechish uchun LLM ni maxsus hisoblash vositalari (masalan, matematik kalkulyator yoki solver) bilan birga ishlatadigan tool-augmented LLM dan foydalanish mumkin.*
